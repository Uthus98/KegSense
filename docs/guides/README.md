# KegSense project guides

Complete build, wiring and operating guides for KegSense v2 on the
`v2-refactor` branch.
...
| Function | DOUT / DATA | SCK |
| --- | --- | --- |
| Scale 1 | GPIO 32 | GPIO 33 |
| Scale 2 | GPIO 16 | GPIO 17 |
| DS18B20 | GPIO 13 | - |
